...
for tovar in goods:
    tovar_numer = goods[tovar]
    store_check = store[tovar_numer]
    quantity_tovar_summ = 0
    price_tovar_summ = 0
    for tovar_unic in store_check:
        quantity_tovar_summ += tovar_unic['quantity']
        price_tovar_summ += tovar_unic['price']
    print(tovar, '-', quantity_tovar_summ, 'шт', 'стоимость', price_tovar_summ, 'руб')
